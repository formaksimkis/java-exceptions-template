...
public class AuthenticationService implements IAuthenticationService {
    ...
    public User login(User user) throws UserNotFoundException, NotCorrectPasswordException {
        ...
        //
        if (foundUser == null) {
            throw new UserNotFoundException(UserNotFoundException.USER_NOT_FOUND_MESSAGE);
        } else if (!foundUser.getPassword().equals(user.getPassword())) {
            throw new NotCorrectPasswordException(NotCorrectPasswordException.NOT_CORRECT_PASSWORD_MESSAGE);
        }
